  ...
  async up (queryInterface, Sequelize) {
   ...
   `);
    await queryInterface.sequelize.query(`
      ...
      ALTER COLUMN "making_charge" TYPE numeric(10,3),
      ALTER COLUMN "finding_charge" TYPE numeric(10,3),
      ALTER COLUMN "other_charge" TYPE numeric(10,3),
      ALTER COLUMN "is_quantity_track" SET DEFAULT false,
      ALTER COLUMN "is_choose_setting" SET DEFAULT '0' ::bit(1),
      ALTER COLUMN "is_single" SET DEFAULT '0' ::bit(1),
      ALTER COLUMN "is_customization" SET DEFAULT '0' ::"bit",
      ALTER COLUMN "meta_title" TYPE character varying,
      ALTER COLUMN "meta_tag" TYPE character varying,
      ALTER COLUMN "meta_description" TYPE character varying,
      ALTER COLUMN "setting_diamond_sizes" TYPE character varying,
      ALTER COLUMN "is_band" DROP DEFAULT;

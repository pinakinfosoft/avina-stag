...
import filterListDataRoute from "./frontend/flter-list-data.route";
import blogsRoute from "./blogs.route";
import orderRoute from "./order.route";
import paymentRoute from "./payment.route";
import subscriptionRoute from "./subscription.route";
import allProductAddCartRoute from "./allProductAddCart";
...
export default () => {
  ...
  filterListDataRoute(app);
  blogsRoute(app);
  orderRoute(app);
  paymentRoute(app);
  subscriptionRoute(app);
  allProductAddCartRoute(app);
